...
public class SandboxConjuntos
{
    ...
    {
    	return new ArrayList<>(arbolCadenas.reversed());
    }
    ...
    public Collection<String> getSiguientes( String cadena )
    {
    	...
    	if(arbolCadenas.ceiling(cadena) == null) {
    		return new TreeSet<String>( );
    	}


        return arbolCadenas.subSet(cadena, true, arbolCadenas.getLast(), true);
    ...
    {
        return  new TreeSet<>(arbolCadenas.reversed());
    }
